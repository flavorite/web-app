...
export class UsersApi extends runtime.BaseAPI {
    ...
    async createUsersWithListInputRaw(requestParameters: CreateUsersWithListInputRequest): Promise<runtime.ApiResponse<User>> {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: requestParameters.createUser.map(CreateUserToJSON),
        });
     ...
     */
    async getReviewsByUsernameRaw(requestParameters: GetReviewsByUsernameRequest): Promise<runtime.ApiResponse<Array<Review>>> {
        if (requestParameters.username === null || requestParameters.username === undefined) {
     ...
     * Get reviews by user name
     */
    async getReviewsByUsername(requestParameters: GetReviewsByUsernameRequest): Promise<Array<Review>> {
