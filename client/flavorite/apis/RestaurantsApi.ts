...
export class RestaurantsApi extends runtime.BaseAPI {
     ...
     */
    async getRestaurantsRaw(requestParameters: GetRestaurantsRequest): Promise<runtime.ApiResponse<Array<Restaurant>>> {
     ...
     * Find restaurants in user location given
     */
    async getRestaurants(requestParameters: GetRestaurantsRequest): Promise<Array<Restaurant>> {
     ...
     */
    async getReviewByRestaurantRaw(requestParameters: GetReviewByRestaurantRequest): Promise<runtime.ApiResponse<Array<Review>>> {
     ...
     * Find reviews by restaurant
     */
    async getReviewByRestaurant(requestParameters: GetReviewByRestaurantRequest): Promise<Array<Review>> {
