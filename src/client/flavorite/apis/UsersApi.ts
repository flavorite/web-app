...
export class UsersApi extends runtime.BaseAPI {
  ...
  async createUserRaw(requestParameters: CreateUserRequest): Promise<runtime.ApiResponse<User>> {
    if (requestParameters.createUser === null || requestParameters.createUser === undefined) {
      throw new runtime.RequiredError(
        'createUser',
        'Required parameter requestParameters.createUser was null or undefined when calling createUser.',
      )
    }
   ...
   */
  async getReviewsByUsernameRaw(
    requestParameters: GetReviewsByUsernameRequest,
  ): Promise<runtime.ApiResponse<ListReviews>> {
    if (requestParameters.username === null || requestParameters.username === undefined) {
      throw new runtime.RequiredError(
        'username',
        'Required parameter requestParameters.username was null or undefined when calling getReviewsByUsername.',
      )
    }
    ...
    const response = await this.request({
      path: `/users/{username}/reviews`.replace(
        `{${'username'}}`,
        encodeURIComponent(String(requestParameters.username)),
      ),
      method: 'GET',
  ...
  async loginUserRaw(requestParameters: LoginUserRequest): Promise<runtime.ApiResponse<string>> {
    if (requestParameters.loginUser === null || requestParameters.loginUser === undefined) {
      throw new runtime.RequiredError(
        'loginUser',
        'Required parameter requestParameters.loginUser was null or undefined when calling loginUser.',
      )
    }
