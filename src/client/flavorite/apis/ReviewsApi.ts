...
export class ReviewsApi extends runtime.BaseAPI {
  ...
  async addReviewRaw(requestParameters: AddReviewRequest): Promise<runtime.ApiResponse<Review>> {
    if (requestParameters.createReview === null || requestParameters.createReview === undefined) {
      throw new runtime.RequiredError(
        'createReview',
        'Required parameter requestParameters.createReview was null or undefined when calling addReview.',
      )
    }
  ...
  async deleteImageRaw(requestParameters: DeleteImageRequest): Promise<runtime.ApiResponse<void>> {
    if (requestParameters.reviewId === null || requestParameters.reviewId === undefined) {
      throw new runtime.RequiredError(
        'reviewId',
        'Required parameter requestParameters.reviewId was null or undefined when calling deleteImage.',
      )
    }
    ...
    const response = await this.request({
      path: `/reviews/{reviewId}/image`.replace(
        `{${'reviewId'}}`,
  ...
  async deleteReviewRaw(
    ...
    if (requestParameters.reviewId === null || requestParameters.reviewId === undefined) {
      throw new runtime.RequiredError(
        'reviewId',
        'Required parameter requestParameters.reviewId was null or undefined when calling deleteReview.',
      )
    }
   ...
   * Find review by ID
   */
  async getReviewByIdRaw(
    requestParameters: GetReviewByIdRequest,
  ): Promise<runtime.ApiResponse<Review>> {
    if (requestParameters.reviewId === null || requestParameters.reviewId === undefined) {
      throw new runtime.RequiredError(
        'reviewId',
        'Required parameter requestParameters.reviewId was null or undefined when calling getReviewById.',
      )
    }
   ...
   */
  async updateReviewbyIdRaw(
    requestParameters: UpdateReviewbyIdRequest,
  ): Promise<runtime.ApiResponse<Review>> {
    if (requestParameters.reviewId === null || requestParameters.reviewId === undefined) {
      throw new runtime.RequiredError(
        'reviewId',
        'Required parameter requestParameters.reviewId was null or undefined when calling updateReviewbyId.',
      )
    }
    ...
    if (requestParameters.updateReview === null || requestParameters.updateReview === undefined) {
      throw new runtime.RequiredError(
        'updateReview',
        'Required parameter requestParameters.updateReview was null or undefined when calling updateReviewbyId.',
      )
    }
  ...
  async uploadImageRaw(
    ...
    if (requestParameters.reviewId === null || requestParameters.reviewId === undefined) {
      throw new runtime.RequiredError(
        'reviewId',
        'Required parameter requestParameters.reviewId was null or undefined when calling uploadImage.',
      )
    }
